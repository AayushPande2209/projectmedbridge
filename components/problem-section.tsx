        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8 text-base md:text-lg text-muted-foreground leading-relaxed">
            <p className="text-foreground font-normal text-lg md:text-xl leading-relaxed">
              Every year, U.S. hospitals discard thousands of pounds of unused, unexpired medical supplies.{" "}
              <a
                href="https://pubmed.ncbi.nlm.nih.gov/25318453/"
                target="_blank"
                rel="noopener noreferrer"
              >
                The World Journal of Surgery
              </a>{" "}
              estimates <strong className="font-bold">2 million pounds</strong> are recoverable annually, representing <strong className="font-bold">$15.4 million</strong> in potential donations that instead enter the waste stream.
            </p>
            <p className="text-foreground font-normal text-lg md:text-xl leading-relaxed">
